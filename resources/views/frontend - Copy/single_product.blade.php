                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="tp-product-details-wrapper">
                            ...
                            <div class="tp-product-details-price-wrapper mb-20">
                                ...
                                <span id="pricespan_new" class="tp-product-details-price new-price"></span>

                                <!-- onclick="setAmount();" -->
                                <select class="form-control select2" name="product_amount" id="product_amount" onchange="calculateAmount();">
                                    @foreach ($product_amount_options as $amt_options)
                                        <option value={{ $amt_options->id }}_{{$amt_options->amount}}> {{ $amt_options->qty_name }} - ₹{{ $amt_options->amount }} </option>
                                    @endforeach
                                </select>

                                <!-- <input type="text" name="hid_product_amount" id="hid_product_amount" value="{{ $min_amount }} "> -->
                            </div>
                                        ...
                                        <div class="tp-product-details-quantity">
                                            <div class="tp-product-quantity mb-15 mr-15">
                                                <div class="mx-0 pt-0">
                                                    ...
                                                    {{-- <!-- <input id="product_amount" hidden type="number" value="{{ $variant_options['amount'] }}" > --> --}}
