                    ...
                    <div class="">
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                <input class="form-control" name="category_name" id="category_name" placeholder="Enter category name" type="text"  value="{{$category->category_name}}"required>
                            </div>
                        </div>
                        <div class="row row-xs align-items-center mg-b-20">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                <input type="file" name="image" id="image" class="dropify" data-default-file="{{ asset('backend/image/category/'.$category->image) }}" data-height="200" accept=".jpg, .png, image/jpeg, image/png, html, zip, css,js" />
                            </div>
                        </div>
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <option value="1"  @if($category->is_active =='1') selected='selected' @endif>Active</option>
                                <option value="0" @if($category->is_active =='0') selected='selected' @endif>InActive</option>
                            </select>
                            </div>
                        </div>
