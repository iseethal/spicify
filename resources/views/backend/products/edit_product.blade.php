                ...
                <div class="card-body">
                    ...
                    <div class="">
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                <input class="form-control" name="product_name" id="product_name" type="text"  value="{{$products->product_name}}"required>
                            </div>
                        </div>
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <option value="1"  @if($products->is_active =='1') selected='selected' @endif>Active</option>
                                <option value="0" @if($products->is_active =='0') selected='selected' @endif>InActive</option>
                            </select>
                            </div>
                        </div>
