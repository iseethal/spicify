        ...
        <div class="col-lg-12 col-md-12">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <form action="{{ route('pincodes.store') }}"  method="POST" enctype="multipart/form-data">
                    ...
                    <div class="">
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                <input class="form-control" name="pincode" id="pincode" placeholder="Enter pincode" type="text" required>
                            </div>
                        </div>
