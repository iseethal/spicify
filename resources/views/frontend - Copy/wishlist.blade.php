                                    ...
                                    @foreach (session('wishlist') as $id => $wishlist_items)
                                        ...
                                        <tr data-id="{{ $id }}">
                                            ...
                                            <td class="tp-cart-img">
                                                <a href="{{ route('frontend.single_product', ['id' => $wishlist_items['id']]) }}">
                                                    <img src="{{ url('backend/images/product_images/' . $wishlist_items['image']) }}" alt="">
                                                </a>
                                            </td>
                                            
                                            <td class="tp-cart-title">
                                                <a href="{{ route('frontend.single_product', ['id' => $wishlist_items['id']]) }}">{{ $wishlist_items['product_name'] }}</a>
                                            </td>
                                            ...
                                            <td class="tp-cart-action">
                                                <a href="{{ route('wishlist.delete',$id)}}" class="tp-cart-action-btn">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($wishlist as $wishlist_items)
                                        <tr>
                                            ...
                                            <td class="tp-cart-img">
                                                <a href="{{ route('frontend.single_product', ['id' => $wishlist_items['variant_option_id']]) }}">
                                                    <img src="{{ url('backend/images/product_images/' . $wishlist_items['image']) }}" alt="">
                                                </a>
                                            </td>
                                            
                                            <td class="tp-cart-title">
                                                <a href="{{ route('frontend.single_product', ['id' => $wishlist_items['variant_option_id']]) }}">{{ $wishlist_items['product_name'] }}</a>
                                            </td>
                                            
                                            <td class="tp-cart-price"><span>₹{{ $wishlist_items['amount'] }}</span></td>                                           
                                            <td class="tp-cart-action">
                                                <a href="{{ route('wishlist.delete',$wishlist_items->id)}}" class="tp-cart-action-btn">
                                                    <svg width="10" height="10" viewBox="0 0 10 10"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                            d="M9.53033 1.53033C9.82322 1.23744 9.82322 0.762563 9.53033 0.46967C9.23744 0.176777 8.76256 0.176777 8.46967 0.46967L5 3.93934L1.53033 0.46967C1.23744 0.176777 0.762563 0.176777 0.46967 0.46967C0.176777 0.762563 0.176777 1.23744 0.46967 1.53033L3.93934 5L0.46967 8.46967C0.176777 8.76256 0.176777 9.23744 0.46967 9.53033C0.762563 9.82322 1.23744 9.82322 1.53033 9.53033L5 6.06066L8.46967 9.53033C8.76256 9.82322 9.23744 9.82322 9.53033 9.53033C9.82322 9.23744 9.82322 8.76256 9.53033 8.46967L6.06066 5L9.53033 1.53033Z"
