...
class CartController extends Controller
{
    ...
    public function AddToWishList(Request $request)
    {
        ...
        if(Auth::id()){
            ...
            if(Session::has('wishlist')){
                ...
                $wishlist->amount_id         = $min_amount_id;
                $wishlist->save();
    ...
    public function WishlistToCart(Request $request)
    {
        if (Auth::id()){
            ...
            $product       = Wishlist::findOrFail($wishlist_id);
            $variant_option_id   = $product->variant_option_id;
            $productname   = VariantOptions::where('id',$variant_option_id)->pluck('name')->first();
            $productimage  = $product->image;
            $amount_id      = $product->amount_id;
            $productamount = $product->amount;
                    ...
                    $cart->total_amount      = $productamount;
                    $cart->save();
