                    ...
                    <div class="">
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                <input class="form-control" name="title" id="title" value="{{ $slider->title}}" placeholder="Enter title" type="text" required>
                            </div>
                        </div>
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                <textarea  class="form-control" type="text" name="description" id="description" cols="10" rows="5"  placeholder="Enter Description"> {{ $slider->description }} </textarea>
                            </div>
                        </div>
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                <input type="file" name="image" id="image" class="dropify" data-default-file="{{ asset('backend/images/slider/'.$slider->image) }}" data-height="200" accept=".jpg, .png, image/jpeg, image/png" />
                            </div>
                        </div>
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <option value="1"  @if($slider->is_active =='1') selected='selected' @endif>Active</option>
                                <option value="0" @if($slider->is_active =='0') selected='selected' @endif>InActive</option>
                            </select>
                            </div>
                        </div>
